...
<html>
  ...
  <body> 
	  <table width="100%" height="48" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#aaaaaa"  bordercolorlight="#FFFFFF">
			  ...
			  <tr style="padding:5px;font-size: 12px;">
				  <td colspan="12" align="center">
				      <s:if test="#request.page.hasPrePage">
				         <a href="showRoleInfo.action?currentPage=1">首页</a>
				         <a href="showRoleInfo.action?currentPage=${request.page.currentPage-1 }">上一页</a>
				      </s:if>
				      <s:else>
				       首页
				       上一页
				       ...
				       <s:if test="#request.page.hasNextPage">
				         <a href="showRoleInfo.action?currentPage=${request.page.currentPage+1 }">下一页</a>
				         <a href="showRoleInfo.action?currentPage=${request.page.totalPage }">尾页</a>
				      </s:if>
				      <s:else>
				       下一页
				       尾页
		 ...
		 <input type="button" value="添加" onclick="window.open('${'showMenuInfo.action'}')">
  </body>
</html>
